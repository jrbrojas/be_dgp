...
return new class extends Migration
{
    ...
    {
        DB::statement(
            "CREATE VIEW incendios_forestales_regionales AS
            SELECT
                pla.*,
            ...
            FROM public.plantilla_a pla
                ...
                LEFT JOIN distritos dr2 ON pla.tipo <> 'IF_DEP_CP' AND pla.cod_ubigeo = dr2.codigo
    ...
    {
        DB::statement("DROP VIEW IF EXISTS incendios_forestales_regionales");
    }
};
