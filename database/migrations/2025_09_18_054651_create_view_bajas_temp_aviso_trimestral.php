...
return new class extends Migration
{
    ...
    {
        DB::statement(
            "CREATE VIEW bajas_temp_aviso_trimestral AS
            SELECT
                pla.*,
                CASE WHEN pla.tipo = 'TRI_DT_CP' THEN d1.nombre ELSE d2.nombre END AS departamento,
                ...
                CASE WHEN pla.tipo = 'TRI_DT_CP' THEN cp.nombre ELSE NULL END AS centro_poblado
    ...
    {
        DB::statement("DROP VIEW IF EXISTS bajas_temp_aviso_trimestral");
    }
};
