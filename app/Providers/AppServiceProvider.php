    ...
    public function boot(): void
{
        Scramble::configure()
            ->withDocumentTransformers(function (OpenApi $openApi) {
                $openApi->info->title = 'Documento de API Integración<br/>
                    APIs de Integración Sistema de Registro DGP<br/>
                    Plataforma Integradora CENEPRED';
                $openApi->info->version = 'v1';
                $openApi->info->description = <<<EOF
                        El presente Documento de API de Integración tiene como finalidad definir, estructurar y describir de manera detallada los servicios de integración que permiten la interoperabilidad entre el Sistema de Registro DGP y la Plataforma Integradora del CENEPRED. Este documento consolida los lineamientos técnicos, especificaciones funcionales y requerimientos de comunicación necesarios para garantizar un intercambio de información seguro, eficiente y trazable entre los sistemas involucrados.
