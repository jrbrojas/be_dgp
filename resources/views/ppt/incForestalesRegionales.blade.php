        ...
        <div class='grid grid-cols-1 lg:grid-cols-4 gap-4'>
            ...
            <div class="w-full flex justify-start">
                <div class="flex flex-col gap-4 w-full">
                    <x-image :src="$escenario->mapas->firstWhere('tipo', $tipo === 'imagen_izquierdo_inc')->ruta ?? ''" />
                </div>
            </div>
            ...
            <div class='col-span-2'>
                <div class='flex flex-col gap-2'>
                    ...
                    <div class='w-full flex flex-col items-center justify-center'>
                        <x-image :src="$escenario->mapas->firstWhere('tipo', $tipo === 'imagen_centro_inc')->ruta ?? ''" />
                    </div>
            ...
            @foreach (array_slice($data, 0, 1) as $index => $item)
                <div class="flex flex-col gap-3 justify-start items-center">
                    ...
                    {{-- Nivel de riesgo --}}
                    <div
                        class="{{ $nivelColorClasses[strtoupper($item['nivel'])] }} text-white text-center font-semibold p-2 w-full rounded">
                        {{ $item['nivel'] }}
                    </div>
                    ...
                    <div class="bg-gray-200/50 rounded-4xl p-5 space-y-5">
                        ...
                        <div class="flex items-center gap-8">
                            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 640 512"
                                class="text-cyan-600" height="50" width="50" xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <div class="flex items-center gap-8">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                class="bi bi-tree-fill text-cyan-600" height="50" width="50" viewBox="0 0 16 16">
                                <path
